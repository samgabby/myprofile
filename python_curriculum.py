...
#SIMPLE OPERATIONS
#Perform sums, multiplications, divisions, subtractions
#Parentheses
#Negatives
#Cause zero division error

#FLOATS
#Floats

#OTHER NUMERICAL OPERATIONS
#Perform exponentiation, modulo, floor division
...
#NUMERIC FUNCTIONS
#Round #Remember, round is a in-built function, not a numeric method
#Min
#Max
#Abs
#Sum 
...
#MAPS AND FILTERS
#Map function using named function
...
#Instance attributes
#'Instance' methods
#Accessing instance attributes and 'instance' methods using an instance
#Accessing 'instance' methods using a class name
#Class attributes
#AttributeError
...
#Magic Methods for logical operators
#Magic Methods for comparison operators
#Magic Methods for container operation

#OBJECT LIFECYCLE
#how do you reduce the reference count of an object?
...
#class method
#factory method?
#access a static method using the class name
#access a static method using an instance of a class
...
#square brackets single range entire alphabet [A-Z]
#square brackets single range numerals [0-9]
#square brackets single range portion of alphabet [?-?]
...
# arbitratry arguments - *args, print(args)
# default arguments
